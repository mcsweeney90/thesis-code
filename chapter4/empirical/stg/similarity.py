...
TODO: would it be better to save DAGs (expensive, ~ 200MB)?
"""
...
with open("timing.txt", "w") as dest:
    print("Time for entire procedure (functions etc timed separately but useful for gauging future runtimes).", file=dest) 
